...
import * as libUtil from "./API/ApiConnection.js";
...
export async function Init(input, opts, output = process.env.DEFAULT_OUTPUT_DIR, print = true) {
    ...
    if(input instanceof Stream)
    {
        ...
        rl.on('close', () => { 
            ...
            if (print) 
                libUtil.PackAllToJSON(out, output, listLength + 1, opts.media, maxPackSize);
        })
	...
	if (print) await libUtil.PackAllToJSON(out, output, listLength + 1, opts.media, maxPackSize);
